    ...
    async execute(interaction) {
        ...
        if (selection === 'Money') {
            ...
            const embed = new EmbedBuilder()
                ...
                .setDescription(`Successfully added **֍ ${amount.toLocaleString()}** to ${user}'s inventory.`)
            ...
            const embed = new EmbedBuilder()
                .setTitle('Item Granted')
                .setDescription(`Successfully added **${amount.toLocaleString()}** ${item.emoji} **${item.name}** to ${user}'s inventory.`)
